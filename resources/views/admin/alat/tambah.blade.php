        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="starter-main">
                ...
                <form method="post" action="{{ base_url() }}master-alat/tambah-proses" class="card" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nm_alat" class="form-control @error('nm_alat') is-invalid @enderror" placeholder="Nama alat" value="{{ old('nm_alat') }}">
                                    @error('nm_alat')
                                ...
                                <div class="form-group">
                                    <label>Alamat:</label>
                                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" placeholder="Alamat alat">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                        <i class="text-danger">* Inputan ini wajib diisi</i>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('jarak_normal') is-invalid @enderror" type="number" placeholder="Jarak normal" name="jarak_normal" value="{{ old('jarak_normal') }}"><span class="input-group-text">cm</span>
                                    </div>
                                    @error('jarak_normal')
                                    <i class="text-danger">* Inputan ini wajib diisi</i>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('jarak_warning') is-invalid @enderror" type="number" placeholder="Jarak warning" name="jarak_warning" value="{{ old('jarak_warning') }}"><span class="input-group-text">cm</span>
                                    </div>
                                    @error('jarak_warning')
                                    <i class="text-danger">* Inputan ini wajib diisi</i>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control @error('jarak_danger') is-invalid @enderror" type="number" placeholder="Jarak danger" name="jarak_danger" value="{{ old('jarak_danger') }}"><span class="input-group-text">cm</span>
                                    </div>
                                    @error('jarak_danger')
                                    <i class="text-danger">* Inputan ini wajib diisi</i>
                                    @enderror
...
@section('footer')
    ...
    $(function() {
        var curlat      = 0.538869304321564;
        var curlng      = 101.44584417343141;
        $("#lat").val(curlat);
        $("#lng").val(curlng);
